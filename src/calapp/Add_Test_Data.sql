...
INSERT INTO `country` (`countryID`, `country`, `createDate`, `createBy`, `lastUpdate`, `lastUpdateBy`) 
VALUES ('1', 'USA', '2017-02-11 00:00:00', 'swade', NULL, NULL), 
('2', 'Mexico', '2017-02-11 00:00:00', 'swade', NULL, NULL);

INSERT INTO `city` (`cityID`, `city`, `countryID`, `createDate`, `createBy`, `lastUpdate`, `lastUpdateBy`) 
...
INSERT INTO `address` (`addressID`, `address`, `address2`, `cityID`, `postalCode`, `phone`, `createDate`, `createBy`, `lastUpdate`, `lastUpdateBy`) 
